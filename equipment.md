...
<ul>
  <li><b>Arduino Due shield:</b> The input and output range of our plant is ±5v while the Arduino Due can only handle signals in the [0,3.3]v range. In order to avoid this problem, a signal conditioner in the shape of a shield has been designed.  </li>
</ul>   

![DueShield](shield.png)

The design of the shield is avaliable in: <https://github.com/DuinoBasedLearning/Lab/blob/master/En/SignalAdapter.pdf>, and the gerbers on <https://github.com/DuinoBasedLearning/Lab/blob/master/Common/GerbersV2.zip>
